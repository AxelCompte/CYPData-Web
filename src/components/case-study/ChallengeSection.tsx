...
export function ChallengeSection({ title = 'The Challenge', points, image }: ChallengeSectionProps) {
                ...
                >
                  <div className="flex gap-4">
                    ...
                    <div className="flex-1">
                      <h3 className="text-2xl md:text-3xl font-bold mb-4 text-white group-hover:text-red-400 transition-colors">
                        {point.title}
                      </h3>
